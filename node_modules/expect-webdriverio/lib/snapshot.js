...
var _SnapshotService_instances, _SnapshotService_currentFilePath, _SnapshotService_currentTestName, _SnapshotService_options, _SnapshotService_snapshotResults, _SnapshotService_snapshotEnvironment, _SnapshotService_snapshotClient, _SnapshotService_isEqual;
...
export class SnapshotService {
    constructor(updateState) {
        ...
        _SnapshotService_snapshotEnvironment.set(this, new NodeSnapshotEnvironment());
        ...
        __classPrivateFieldSet(this, _SnapshotService_options, {
            ...
            snapshotEnvironment: __classPrivateFieldGet(this, _SnapshotService_snapshotEnvironment, "f"),
        }, "f");
    }
    get currentFilePath() {
    ...
    beforeTest(test) {
        ...
        __classPrivateFieldGet(this, _SnapshotService_snapshotClient, "f").startCurrentRun(test.file, test.fullTitle, __classPrivateFieldGet(this, _SnapshotService_options, "f"));
    }
    async after() {
    ...
    static initiate(updateState = 'new') {
        if (!service) {
...
_SnapshotService_currentFilePath = new WeakMap(), _SnapshotService_currentTestName = new WeakMap(), _SnapshotService_options = new WeakMap(), _SnapshotService_snapshotResults = new WeakMap(), _SnapshotService_snapshotEnvironment = new WeakMap(), _SnapshotService_snapshotClient = new WeakMap(), _SnapshotService_instances = new WeakSet(), _SnapshotService_isEqual = function _SnapshotService_isEqual(received, expected) {
    try {
